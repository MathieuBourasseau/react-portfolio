            ...
            <div className="group grid grid-cols-1 gap-6 py-8 px-[5%]">
                ...
                {projects.map((project, i) => (
                    <article
                        key={i}
                        className="
                            relative group/card flex flex-col overflow-hidden text-sm text-white cursor-pointer  h-[200px] rounded-lg  transition-all duration-300 ease-in-out ring-0  hover:ring-2 hover:ring-[#2C3E50] ring-inset   hover:scale-105  hover:shadow-[0_0_10px_#2C3E50,0_0_20px_rgba(44,62,80,0.5),0_0_40px_rgba(44,62,80,0.3)]
                        "
                    >
                        <div
