                ...
                {projects.map((project, i) => (
                    project.available ? (
                        <motion.a
                            ...
                            className="relative group/card flex flex-col items-center justify-center overflow-hidden text-sm text-white cursor-pointer h-[200px] rounded-lg transition-transform transition-shadow duration-300 ease-in-out ring-0 w-full max-w-[450px] md:max-w-[350px] lg:max-w-[400px] hover:ring-2 hover:ring-[#2C3E50] ring-inset hover:scale-105 hover:shadow-[0_0_10px_#2C3E50,0_0_20px_rgba(44,62,80,0.5),0_0_40px_rgba(44,62,80,0.3)]"
                        >
                            <Image
                                src={project.img}
                                alt={project.title}
